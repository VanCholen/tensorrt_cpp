...
void my_test()
{
    ...
    //     TRT::Mode::FP32,
    //     1,
    //     "/home/morvan/python/test/yolov5/yolov5s.onnx",
    //     "yolov5s.trtmodel");
    // INFO("Generate model Done!"); 
    ...
    auto image = cv::imread("/home/morvan/python/test/tensorRT_Pro/workspace/inference/car.jpg");
    ...
    cv::imwrite("test-yolov5s-car.jpg", image);
}
